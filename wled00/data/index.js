...
function selWing(id)
{
	let el = gId(`Cseg${id}sel`);
	requestJson({"seg": {"id": id,"sel": !el.checked}});
}
	...
	for (var inst of (s.seg||[])) {
		...
		cn += `<div class="seg lstI ${i==s.mainseg ? 'selected' : ''} ${exp ? "expanded":""}" id="seg${i}" data-set="${inst.set}">`+
				...
				`<div class="segname" onclick="selSegEx(${i})">`+
					`<i class="icons e-icon frz" id="icons${i}frz" onclick="event.preventDefault();tglFreeze(${i});">&#x${inst.frz ? (li.live && li.liveseg==i?'e410':'e0e8') : 'e325'};</i>`+
...
function resetCustomSegmentView()
{
	for(let j = 0; j < 6; j++) {
		const wing = gId(`w${j}`);
		wing.setAttribute('style', `fill: #fff`);
	}
}

function updateCustomSegmentView(s)
{		
	resetCustomSegmentView();
	
	for (var inst of (s.seg||[])) {
		console.log(`Start ${inst.start}. Stop ${inst.stop}`);
		...
		for(let j = inst.start; j < inst.stop; j++) {
			const wing = gId(`w${j}`);
			wing.setAttribute('style', `fill: ${cG}`);
		}
	}
}

function makeCustomSegmentView()
{
	const paths = [
		"m 39.635091,43.094562 c -0.897513,-0.33698 -2.419906,-0.90746 -3.38308,-1.26765 -0.963175,-0.36023 -2.07362,-0.77578 -2.467648,-0.92347 -0.394028,-0.1476 -0.716415,-0.30802 -0.716415,-0.35625 0,-0.0825 0.571383,-0.33964 5.49252,-2.47054 1.094516,-0.47395 2.948246,-1.27756 4.119389,-1.78583 1.171142,-0.50826 3.087543,-1.3399 4.258686,-1.84809 1.171142,-0.50818 2.284556,-0.99177 2.474247,-1.07462 0.189709,-0.0829 0.374792,-0.15062 0.411309,-0.15062 0.03648,0 0.444967,0.72488 0.907667,1.61087 0.794111,1.52052 0.833543,1.61823 0.703139,1.74244 -0.07596,0.0725 -1.750103,1.27609 -3.720245,2.67492 -1.970143,1.39884 -4.191031,2.97832 -4.935314,3.50998 -0.744264,0.53167 -1.389037,0.96328 -1.432831,0.95915 -0.04382,-0.004 -0.813912,-0.28322 -1.711424,-0.62024 z",
		"m 26.529519,36.695692 c -0.51928,-0.36361 -1.929208,-1.33677 -3.133181,-2.1626 -1.203973,-0.82584 -2.636805,-1.81187 -3.184082,-2.19119 -0.547258,-0.37931 -1.525852,-1.0574 -2.17465,-1.50684 -0.64878,-0.44946 -1.159484,-0.83734 -1.134851,-0.86198 0.04174,-0.0417 7.933315,-0.84935 11.866699,-1.2144 0.963175,-0.0893 1.894515,-0.17883 2.069633,-0.19868 0.175061,-0.0199 0.909453,-0.0919 1.631847,-0.16002 3.109207,-0.29311 13.936409,-1.44349 14.804268,-1.57294 0.08217,-0.0132 0.293015,0.39224 0.696464,1.33566 0.318289,0.74428 0.666926,1.55845 0.774763,1.80927 l 0.196065,0.45603 -2.245746,0.72794 c -2.077493,0.67339 -9.56176,3.12347 -16.16147,5.29067 -1.524311,0.50055 -2.836761,0.91009 -2.916544,0.91009 -0.07972,0 -0.569937,-0.29747 -1.089215,-0.66108 z",
0.782417,-0.792992 0.782435,-0.79299 0.497091,-1.983599 0.49709,-1.983597 -0.642705,-0.126642 C 59.148692,11.486262 58.618996,11.311641 58.325058,11.167875 57.75531,10.889201 57.061385,10.261495 56.904599,9.882947 56.813968,9.663982 56.789706,9.65535 56.266878,9.65535 c -0.645997,0 -1.51914,0.255102 -2.601417,0.76003 -0.478945,0.223455 -0.73631,0.307492 -0.73631,0.240434 0,-0.134278 0.886815,-1.937475 1.255421,-2.552699 1.098992,-1.834324 2.688589,-3.438486 4.362933,-4.402924 1.822252,-1.049641 3.591874,-1.56563 6.879112,-2.005824 2.803197,-0.375376 3.740028,-0.66829 4.396628,-1.374692 L 70.120399,0 70.456061,0.230674 c 0.534115,0.367045 1.801867,1.614469 2.173617,2.138732 1.53651,2.166992 1.44011,4.105627 -0.30492,6.13089 l -0.27363,0.317578 0.35569,0.708214 c 0.9363,1.864312 1.92686,4.161412 2.10519,4.881994 0.0707,0.28589 0.2951,0.637873 0.8946,1.40361 l 0.80013,1.022032 0.67958,-0.04526 c 0.37375,-0.02487 2.50642,-0.06449 4.73924,-0.08802 2.23283,-0.02352 4.40895,-0.06395 4.83581,-0.08984 0.5107,-0.03097 0.77612,-0.01899 0.77612,0.03507 0,0.07837 -0.41594,0.758187 -2.15186,3.517119 -0.427,0.678604 -1.64505,2.630841 -2.70681,4.33829 -1.06177,1.707457 -2.31384,3.713419 -2.78237,4.457699 -0.46853,0.74427 -1.36346,2.1771 -1.98874,3.18407 -0.62527,1.00697 -1.51992,2.43979 -1.98813,3.18407 -0.46819,0.74427 -0.9279,1.48062 -1.02158,1.63631 -0.14742,0.24517 -0.18108,0.47993 -0.25071,1.75126 l -0.0803,1.46814 0.29027,0.47761 c 0.15965,0.26269 0.67261,1.06864 1.13993,1.79104 0.46733,0.72237 1.27315,1.97611 1.79068,2.78605 0.51755,0.80994 1.28782,2.00995 1.71171,2.66666 0.6764,1.04792 1.91315,2.97497 4.90273,7.63926 0.44809,0.69911 0.79599,1.3014 0.77312,1.33841 -0.0229,0.037 -0.36939,0.22235 -0.77006,0.41187 -0.40066,0.1895 -1.31952,0.6307 -2.04189,0.98043 -3.36938,1.63119 -4.15977,2.00791 -4.20741,2.00537 -0.0282,-10e-4 -0.82144,-1.34714 -1.76272,-2.99029 -0.94131,-1.64313 -1.95311,-3.40608 -2.24846,-3.91765 l -0.53703,-0.9301 -0.002,0.39801 c -0.002,0.34658 -0.30392,10.87577 -0.31302,10.9235 -0.002,0.009 -0.3527,0.28042 -0.77956,0.60108 -0.629301,0.4727 -3.891624,2.93379 -4.200792,3.16905 -0.04644,0.0353 -0.474621,-0.23562 -0.995029,-0.62946 z" />`;
	
	// const paths = pathEls.reverse();

	for (const [i, el] of (paths||[]).entries()) {
		content += `<path id="w${i}" d="${paths[i]}"/>`;
	}

	content += `</svg>`;

	gId('customSegments').innerHTML = content;
}
